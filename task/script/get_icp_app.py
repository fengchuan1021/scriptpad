...
class Main(basetask.BaseTask):
    ...
    args = {
        'outtable': {'name': 'outtable', 'value': "", 'alisaname': "结果输出表", 'formator': 'ljz_domain_icp_app_{now}'}
    }
    ...
    async def startremote(self):
        ...
        cmd = f"sudo /home/ant/conda/bin/python /home/ant/lg/scripts/app_icp.py '{json.dumps(dic)}'"
        print(cmd)
